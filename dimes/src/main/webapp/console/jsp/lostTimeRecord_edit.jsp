				...
				<div class="topjui-fluid">
					...
					<div class="topjui-row">
						<div class="topjui-col-sm12">
							...
							<div class="topjui-input-block">
								<input name="beginTime" data-toggle="topjui-datetimebox" data-options="required:true,width:150,showSeconds:true"
								id="beginTime">
					...
					<div class="topjui-row">
						<div class="topjui-col-sm12">
							...
							<div class="topjui-input-block">
								<input name="endTime" data-toggle="topjui-datetimebox" data-options="required:true,width:150,showSeconds:true"
								id="endTime">
							</div>
						</div>
					</div>
