         ...
         data-toggle="topjui-treegrid"
            ...
            <tr>
               <!--  <th data-options="field:'id',title:'id',checkbox:true"></th> -->
                <th data-options="field:'name',width:'100%',title:'不良原因类型'"></th>
            </tr>
            </thead>
        </table>
    </div>
        ...
        <div data-toggle="topjui-layout" data-options="fit:true">
            <div data-options="region:'center',title:'',fit:false,split:true,border:false,bodyCls:'border_bottom'"
                ...
                data-toggle="topjui-datagrid"
                       ...
                       url:'ngReasonType/queryNGReasonTypesByParentId.do',
                       singleSelect:true,
                       fitColumns:true,
                       pagination:true,
                       parentGrid:{
            ...
            <div data-options="region:'south',fit:false,split:true,border:false"
                ...
                <div data-toggle="topjui-tabs"
                     ...
                     parentGrid:{
                         type:'datagrid',
                         id:'departmentDg',
                         param:'ngReasonTypeId:id'
                     }">
                    <div title="不良原因信息" data-options="id:'tab0',iconCls:'fa fa-th'">
                        <!-- datagrid表格 -->
                        <table 
                         data-toggle="topjui-datagrid"
                               ...
                               singleSelect:true,
                               fitColumns:true,
						       url:'ngReason/queryNGReasonsByNGReasonTypeId.do'">
                            <thead>
                            <tr>
...
<div id="departmentDg-toolbar" class="topjui-toolbar"
    ...
    <a href="javascript:void(0)"
       ...
       dialog:{
           ...
           width:600,
           height:400,
           href:'console/jsp/ngReasonType_add.jsp',
           buttons:[
           	{text:'保存',handler:function(){
           			...
           			$.get('ngReasonType/addNGReasonType.do',{
           			code:code,
           			name:name,
    ...
    <a href="javascript:void(0)"
       ...
       data-options="method: 'openDialog',
            ...
            dialog: {
                ...
                width: 600,
                height: 400,
                href: 'console/jsp/ngReasonType_edit.jsp',
                url:'ngReasonType/queryNGReasonTypeById.do?id={id}',
                 buttons:[
           	{text:'编辑',handler:function(){
           			...
           			$.get('ngReasonType/updateNGReasonType.do',{
    ...
    <a href="javascript:void(0)"
       ...
       extend: '#departmentDg-toolbar',
       iconCls:'fa fa-trash',
       url:'ngReasonType/deleteNGReasonType.do',
...
<!--     <a href="javascript:void(0)"
    ...
    <a href="javascript:void(0)"
       ...
       extend: '#departmentDg-toolbar',
       iconCls:'fa fa-stop',
       url:'ngReasonType/disabledNGReasonType.do',
       ...
       dialog:{
           ...
           buttons:[
           	{text:'保存',handler:function(){
           			...
           			'ngReasonType.id':$('#departmentDg').iDatagrid('getSelected').id,
           			note:$('#note').val()
           			},function(data){
           				if(data.success){
