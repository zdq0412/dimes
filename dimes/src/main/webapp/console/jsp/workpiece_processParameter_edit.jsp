				...
				<div class="topjui-fluid">
					...
					<div class="topjui-row">
						<div class="topjui-col-sm12">
							...
							<div class="topjui-input-block">
								<input type="number" name="upLine" data-toggle="topjui-textbox"
									id="upLine">
							</div>
						</div>
					</div>
					<div class="topjui-row">
						<div class="topjui-col-sm12">
							...
							<div class="topjui-input-block">
								<input type="number" name="lowLine" data-toggle="topjui-textbox"
									id="lowLine">
							</div>
						</div>
					</div>
					<div class="topjui-row">
						<div class="topjui-col-sm12">
							...
							<div class="topjui-input-block">
								<input type="number" name="standardValue" data-toggle="topjui-textbox"
									id="standardValue">
							</div>
						</div>
					</div>
