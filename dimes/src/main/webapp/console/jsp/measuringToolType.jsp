         ...
         data-toggle="topjui-treegrid"
            ...
            <tr>
               <!--  <th data-options="field:'id',title:'id',checkbox:true"></th> -->
                <th data-options="field:'name',width:'100%',title:'量具类型'"></th>
            </tr>
            </thead>
        </table>
    </div>
        ...
        <div data-toggle="topjui-layout" data-options="fit:true">
            ...
            <div data-options="region:'south',fit:false,split:true,border:false"
                ...
                <div data-toggle="topjui-tabs"
                    ...
                    <div title="量具信息" data-options="id:'tab0',iconCls:'fa fa-th'">
                        <!-- datagrid表格 -->
                        <table 
                         data-toggle="topjui-datagrid"
                            ...
                            <tr>
                                <th data-options="field:'id',title:'id',checkbox:true"></th>
                                <th data-options="field:'code',title:'量具代码',sortable:false"></th>
                                <th data-options="field:'name',title:'量具名称',sortable:false"></th>
