			           ...
			           childTab: [{id:'southTabs'}]">
						<thead>
                         ...
                         if (value) {
								...
								<th
									data-options="field:'equipmentCode',title:'量具代码',sortable:false,formatter:function(value,row,index){
                         if (row.equipment) {
								...
								<th
									data-options="field:'equipmentName',title:'量具名称',sortable:false,formatter:function(value,row,index){
                        			 if (row.equipment) {
								...
								<th	data-options="field:'equipmentType',title:'量具类别',sortable:false,formatter:function(value,row,index){
				                         if (row.equipment) {
								...
								<th
									data-options="field:'pressLightUserName',title:'计量类型',sortable:false,formatter:function(value,row,index){
                        			 if (row.equipment) {
                                        return row.equipment.measurementType;
                                    }else{
                                    	return '';
                                    }
                        		}"></th>
								<th
									data-options="field:'lightOutUserName',title:'计量目标',sortable:false,formatter:function(value,row,index){
                        			 if (row.equipment) {
                                        return row.equipment.measurementObjective;
                                    }else{
                                    	return '';
                                    }
                        		}"></th>
								<th
									data-options="field:'lightOutTime',title:'计量累计',sortable:false,formatter:function(value,row,index){
                        			 if (row.equipment) {
								...
								<th data-options="field:'recovered',title:'计量差异',sortable:false,formatter:function(value,row,index){
                        			 if (row.equipment) {
								...
								<th data-options="field:'no',title:'序列号',sortable:false"></th>
								<th
