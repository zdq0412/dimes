            ...
            <div data-options="region:'center',title:'',fit:false,split:true,border:false,bodyCls:'border_bottom'"
                ...
                data-toggle="topjui-datagrid"
                    ...
                    <tr>
                        ...
                        <th data-options="field:'code',title:'生产单元代码',width:'180px',align:'center'"></th>
                        <th data-options="field:'name',title:'生产单元名称',sortable:false"></th>
                        <th data-options="field:'note',title:'备注',sortable:true"></th>
                        <th data-options="field:'parentCode',title:'上级单元代码',sortable:true,
                        ...
                        <th data-options="field:'parentName',title:'上级单元名称',sortable:true, 
                        formatter:function(value,row,index){
                            if (row.parent) {
