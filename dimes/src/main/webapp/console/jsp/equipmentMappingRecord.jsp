			           ...
			           childTab: [{id:'southTabs'}]">
						<thead>
                         ...
                         if (value) {
								...
								<th
									data-options="field:'equipmentCode',title:'装备代码',sortable:false,formatter:function(value,row,index){
                         if (row.equipment) {
								...
								<th
									data-options="field:'equipmentName',title:'装备名称',sortable:false,formatter:function(value,row,index){
                        			 if (row.equipment) {
								...
								<th	data-options="field:'equipmentType',title:'装备类别',sortable:false,formatter:function(value,row,index){
				                         if (row.equipment) {
